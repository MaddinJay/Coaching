*&---------------------------------------------------------------------*
*& Report ymj_abap_test_double_demo
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ymj_abap_test_double_demo.
CLASS lcl_cut DEFINITION
  ...
  PUBLIC SECTION.
    INTERFACES yif_mj_atd_demo.
    METHODS constructor
      IMPORTING
        atd_aunit TYPE REF TO yif_mj_atd_demo.

  PRIVATE SECTION.
    DATA: mr_atd_aunit TYPE REF TO yif_mj_atd_demo.
ENDCLASS.
...
DURATION SHORT
  ...
  PRIVATE SECTION.
    ...
    METHODS on_action_done FOR EVENT action_done OF yif_mj_atd_demo IMPORTING param_name.
    METHODS decision_table_init_bad.

    DATA: test_double TYPE REF TO yif_mj_atd_demo,
...
CLASS lcl_cut IMPLEMENTATION.
  ...
  ENDMETHOD.
  METHOD yif_mj_atd_demo~exporting.
    mr_atd_aunit->exporting(
      IMPORTING
        result = result
    ).
  ENDMETHOD.
  METHOD yif_mj_atd_demo~demo_raise_exception.
    mr_atd_aunit->demo_raise_exception( ).
  ENDMETHOD.
  METHOD yif_mj_atd_demo~demo_raise_exception2.
    result = mr_atd_aunit->demo_raise_exception2( whatever ).
  ENDMETHOD.
  METHOD yif_mj_atd_demo~demo_returning.
    result = mr_atd_aunit->demo_returning( ).
  ENDMETHOD.
  METHOD yif_mj_atd_demo~importing_optional.
    ...
    ENDIF.
  ENDMETHOD.
  METHOD yif_mj_atd_demo~importing_required.
    result = mr_atd_aunit->importing_required( whatever ).
  ENDMETHOD.
  METHOD yif_mj_atd_demo~changing.
    mr_atd_aunit->changing( CHANGING whatever = whatever ).
  ENDMETHOD.
  METHOD yif_mj_atd_demo~demo_raise_event.
    mr_atd_aunit->demo_raise_event( ).
  ENDMETHOD.
  METHOD yif_mj_atd_demo~several_cases.
    result = mr_atd_aunit->several_cases( whatever = whatever ).
  ENDMETHOD.
  METHOD yif_mj_atd_demo~decision_table.
    result = mr_atd_aunit->decision_table( p1 = p1 p2 = p2 ).
  ENDMETHOD.
  METHOD yif_mj_atd_demo~exporting_returning.
...
CLASS ltc_atd_aunit IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    test_double ?= cl_abap_testdouble=>create( 'yif_mj_atd_demo' ).
  ...
  METHOD raise_exception_good.
    ...
    DATA: lx_exp TYPE REF TO cx_demo_exception,
          lx_act TYPE REF TO cx_demo_exception.
    ...
    TRY.
        cut->yif_mj_atd_demo~demo_raise_exception( ).
      CATCH cx_demo_exception INTO lx_act.
    ENDTRY.
  ...
  METHOD raise_exception_good2.
    ...
    TRY.
        cut->yif_mj_atd_demo~demo_raise_exception2( 20 ).
      CATCH lcx_cut INTO lx_act.
    ENDTRY.
    assert_equals( exp = lx_exp act = lx_act ).

    result = cut->yif_mj_atd_demo~demo_raise_exception2( 30 ).
  ...
  METHOD exporting_good.
    ...
    cut->yif_mj_atd_demo~exporting( IMPORTING result = result ).
  ...
  METHOD returning_good.
    ...
    result = cut->yif_mj_atd_demo~demo_returning( ).
  ...
  METHOD exporting_returning_good.
    ...
    result = cut->yif_mj_atd_demo~exporting_returning( IMPORTING exporting = exporting ).
  ...
  METHOD importing_required_bad.
    ...
    result = cut->yif_mj_atd_demo~importing_required( 5555 ).
  ...
  METHOD importing_required_good2.
    ...
    DATA(double_config) = cl_abap_testdouble=>configure_call( test_double ).
    double_config->ignore_parameter( 'WHATEVER' ).
    double_config->returning( 97 ).
  ...
  METHOD importing_optional_bad.
    ...
    result = cut->yif_mj_atd_demo~importing_optional( 5555 ).
  ...
  METHOD importing_optional_good.
    ...
    result = cut->yif_mj_atd_demo~importing_optional( whatever = 5555 ).
  ...
  METHOD importing_optional_good2.
    ...
    result = cut->yif_mj_atd_demo~importing_optional( ).
  ...
  METHOD changing_good.
    ...
    whatever = 0.
    cut->yif_mj_atd_demo~changing( CHANGING whatever = whatever ).
  ...
  METHOD several_cases_good.
    ...
    result = cut->yif_mj_atd_demo~several_cases( 27 ).
    assert_equals( exp = 40 act = result ).

    result = cut->yif_mj_atd_demo~several_cases( 29 ).
  ...
  METHOD decision_table_good.
    ...
    result = cut->yif_mj_atd_demo~decision_table( p1 = 66 p2 = 66 ).
    assert_equals( exp = 40 act = result ).
    result = cut->yif_mj_atd_demo~decision_table( p1 = 66 p2 = 66 ).
    assert_equals( exp = 40 act = result ).
    " Scenario Outline
    ...
    result = cut->yif_mj_atd_demo~decision_table( p1 = 5 p2 = 66 ).
    assert_equals( exp = 30 act = result ).
    result = cut->yif_mj_atd_demo~decision_table( p1 = 5 p2 = 66 ).
    assert_equals( exp = 30 act = result ).
    " 2) The possible cases are 20 and 40:
    result = cut->yif_mj_atd_demo~decision_table( p1 = 66 p2 = 5 ).
    assert_equals( exp = 20 act = result ).
    result = cut->yif_mj_atd_demo~decision_table( p1 = 66 p2 = 5 ).
    assert_equals( exp = 20 act = result ).
    " 3) The possible cases are 10, 20, 30 and 40:
    result = cut->yif_mj_atd_demo~decision_table( p1 = 5 p2 = 5 ).
  ...
  METHOD raise_event_good.
    ...
    cut->yif_mj_atd_demo~demo_raise_event( ).
